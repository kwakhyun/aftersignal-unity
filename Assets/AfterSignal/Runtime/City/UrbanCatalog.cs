...
namespace AfterSignal
{
    public static class UrbanCatalog
    {
        ...
        {
            "관리실과 공동 거실, 주민의 방을 둘러볼 수 있습니다.",
            "분실물 신고와 지역 안전 안내를 받는 민원실입니다.",
            "소방대원들이 교대 근무를 준비하는 차고와 휴게실입니다.",
            "은행 창구와 상담 공간입니다. 기억 기록도 소중한 자산이지요.",
            "도시 주민을 위한 진료실입니다. 잠시 쉬며 체력을 회복하세요.",
            "학생들의 기록을 보관하는 교실과 도서 코너입니다.",
            "생활용품과 의류 매장을 연결하는 백화점입니다.",
            "늦은 밤에도 필요한 식료품을 구할 수 있는 마트입니다.",
            "수선한 옷에도 새로운 이야기가 깃듭니다. 진열대를 둘러보세요.",
            "따뜻한 식사를 먹고 체력을 회복할 수 있습니다.",
            "대합실과 승강장입니다. 본부에서 받은 중앙역 임무도 시작할 수 있습니다.",
            "차를 주유기 옆에 세우고 E를 누르세요. 멈춘 동안 연료가 채워집니다.",
            "주차된 차량은 E로 탑승할 수 있습니다. 출차할 때 보행자를 살펴주세요.",
            "도시의 생활 물자를 보관하는 물류 창고입니다.",
        ...
        {
            int block = site / 2;
            return new Vector3(85 + (block % 5) * 140 + (site % 2) * 50, 0, -210 + (block / 5) * 140);
        }
        ...
        public static void Exit(GameDirector game)
        {
            CivicWorld.Travel(game, StageId.UrbanCity, Door(Current) + Vector3.back * 2);
        }
