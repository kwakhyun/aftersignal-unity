...
이번 요청의 기능은 적용·검증했습니다. 시설은 16종 내부 구성을 재사용하며 추가 고층 건물은 외형입니다. 건축·차량은 프로젝트용 메시와 이미지 조합이며 세부 아트 검수는 남아 있습니다. 우선 남은 과제는 장시간 교통 밀집·종료 반복 검증, 시민 외형 다양화, 차체 세부 손상 아트, 실제 청취 믹싱입니다. 경찰 추격이나 경제 시스템은 이번 구현 범위에 포함하지 않습니다.
