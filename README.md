...
**타이틀 화면** — 서하와 핵심 인물, 게임 로고, 새 게임·이어하기 메뉴.

![AFTERSIGNAL 타이틀 화면](Documentation/Screenshots/title-screen.png)

**스토리 대화** — 상반신 일러스트와 화면 하단 대화창.

![서하의 스토리 대화 화면](Documentation/Screenshots/story-dialogue.png)

**잠식 몬스터와의 전투** — 경찰과 방위군이 함께 사격하며 도심에 출현한 잠식 거신을 제압합니다.

![잠식 몬스터와 교전하는 경찰과 방위군](Documentation/Screenshots/monster-battle.png)

**지도와 목적지 설정** — 네 도시의 시설을 검색하고 이동 경로를 설정합니다.

![도시 지도와 목적지 설정 화면](Documentation/Screenshots/city-map.png)

**밀도 높은 도시 야경** — 건물 조명이 켜진 애프터라이트에서 시민과 차량 사이로 운전하는 서하.

![시민과 차량이 많은 애프터라이트 야경 속에서 운전하는 서하](Documentation/Screenshots/city-driving.png)
...
- **NPC**: 직업·시간대·위험 상황에 따른 대화와 반응. 주변 인물의 부상·사망을 목격하면 소속·나이에 맞는 랜덤 말풍선을 표시합니다. 자유 대화에서는 서하의 자동 인사 없이 NPC가 먼저 말합니다. 고정 스토리는 작성된 시나리오를 사용합니다.
